...
export const defaultSportVideo =
  import.meta.env.VITE_APP_BASE_API +
  `/oms-system/${import.meta.env.VITE_SITE === 'cn' ? 'cn' : 'vnm'}-sport.mp4`
export const downloadLink =
  import.meta.env.VITE_APP_DOWNLOAD_URL + `/?domain=${window.location.origin}`
export const currentLink = window.location.origin
...
import vip11 from '@/assets/img/vip11.png'
// vip等级icon
...
import Cricket from '@/assets/img/sport/cricket-inactive.png'
...
import CricketActive from '@/assets/img/sport/cricket-active.png'
/**
