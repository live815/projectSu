<template>
  <div class="addVirtual">
    <NavBar :title="$t('AddPage.BindEbPayCurrency')" />
    <HeadlineTitle style="margin-top: 0" :leftTitle="$t('AddPage.OtherName')"></HeadlineTitle>
    <van-cell-group inset>
      <van-field
        class="border-cell"
        v-model="virtualFrom.alias"
        :placeholder="$t('AddPage.EbPayTip1')"
      />
    </van-cell-group>
    <HeadlineTitle :leftTitle="$t('AddPage.EbPayTip2')"></HeadlineTitle>
    <van-cell-group inset>
      <van-field
        class="border-cell"
    ...
    <HeadlineTitle :leftTitle="$t('AddPage.EbPayTip3')"></HeadlineTitle>
    <VirtualList
...
const virtualKind = reactive([
  {
    id: 1,
    name: i18n.global.t('AddPage.EbPay'),
    icon: new URL('./img/ebpayIogo.png', import.meta.url).href
  }
])
