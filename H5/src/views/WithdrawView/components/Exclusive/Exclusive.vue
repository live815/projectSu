<template>
  <div class="Exclusive-content">
    ...
    <div class="general-box-padding">
      <div class="Exclusive-content-addBank">
        <div class="Exclusive-content-addBank-item">
          <div class="Exclusive-content-addBank-item-left">
            <img class="img" :src="cardIcon" />
            <div class="title">
              {{ isBankShow ? $t('Wletter.Depositsbankcard') : $t('Wletter.Chooseyourbank') }}
            </div>
          </div>
          <div class="Exclusive-content-addBank-item-right"></div>
        </div>
        <div class="Exclusive-content-addBank-item" @click="onClickBankCardPopup">
          <div class="Exclusive-content-addBank-item-left" v-if="isBankShow">
            <img class="imgs" :src="getImg(addBnakInfo.icon)" />
            <div class="texts">{{ addBnakInfo.bankname }}</div>
          </div>
          <div class="Exclusive-content-addBank-item-left" v-else>
            <div class="text">{{ $t('Wletter.tip93') }}</div>
          </div>
          <div class="Exclusive-content-addBank-item-right">
...
.Exclusive-content {
  ...
  .Exclusive-content-addBank {
    width: 343px;
    border-radius: 8px;
    background: #f7f7f7;

    .Exclusive-content-addBank-item {
      display: flex;
      align-items: center;
      justify-content: space-between;
      height: 44px;
      .Exclusive-content-addBank-item-left {
        display: flex;
        align-items: center;
        .img {
          width: 16px;
      ...
      .Exclusive-content-addBank-item-right {
        width: 16px;
        height: 16px;
        margin-right: 16px;
        img {
    ...
    .Exclusive-content-addBank-item:nth-child(1) {
