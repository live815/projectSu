<template>
  <el-form :model="queryParams" ref="ruleFormRef" :rules="rules" label-width="130px">
    ...
    <el-form-item :label="$t('newbie.form.label18')" prop="achievedDays">
      <el-input
    ...
    <el-form-item :label="$t('newbie.form.label34')" prop="playGame">
      <PlayTheGame
        ...
        :disabled="Boolean(queryParams.id)"
      ></PlayTheGame>
    </el-form-item>
...
import RewardContentList from './NewbieRewardContentListType3.vue'
...
const rules = {
  ...
  achievedDays: [
    {
      required: true,
      message: i18n.global.t('newbie.form.message17'),
      trigger: 'blur'
    }
  ],
  gifts: [
