<template>
  <el-dialog v-model="visible" :title="$t('operation.add2')" width="800px" :center="true">
    <el-form :model="queryParams" ref="queryRef" label-width="130px" :rules="rules">
      ...
      <el-form-item :label="$t('newbie.form.label26')" prop="giftAmount">
        <el-input
      ...
      <el-form-item :label="$t('newbie.form.label25')" prop="profitAmount">
        <el-input
      ...
      <el-form-item :label="$t('newbie.form.label24')" prop="profitRate">
        <el-input
...
watchEffect(() => {
  queryParams.value = props.gearObj
    ...
    : {
        ...
        depositAmount: null, //存款金额，签到礼包所需
        giftAmount: null, //奖励金额
        giftType: 1, //奖品类型：1现金，2现金券，3存送券，4流水券，5实物
        profitAmount: null, //负盈利金额，复活礼包所需
        profitRate: null, //负盈利比例，百分比，复活礼包所需
        validBet: null //有效投注，签到礼包所需
      }
})
...
const rules = {
  ...
  giftAmount: [
    {
      required: true,
      message: i18n.t('newbie.form.message13'),
      trigger: 'blur'
    }
  ],
  validBet: [
    {
      required: true,
      message: i18n.t('newbie.form.message10'),
      trigger: 'blur'
    }
  ],
  betMultiple: [
    {
      required: true,
      message: i18n.t('newbie.form.message8'),
      trigger: 'blur'
    }
  ],
  depositAmount: [
    {
      required: true,
      message: i18n.t('newbie.form.message9'),
      trigger: 'blur'
    }
  ],
  profitRate: [
    {
      required: true,
      message: i18n.t('newbie.form.message11'),
      trigger: 'blur'
    },
    {
      validator: (rule, value, callback) => {
        ...
        if (!(num > 0 && num <= 100)) callback(new Error(i18n.t('newbie.form.message20')))
        callback()
      },
      trigger: 'blur'
    }
  ...
  profitAmount: [
    {
      required: true,
      message: i18n.t('newbie.form.message12'),
      trigger: 'blur'
    }
  ]
}
