<template>
  <el-dialog v-model="visible" :title="$t('operation.add2')" width="800px" :center="true">
    <el-form :model="queryParams" ref="queryRef" label-width="130px" :rules="rules">
      ...
      <el-form-item :label="$t('newbie.form.label22')" prop="depositAmount">
        <el-input
      ...
      <el-form-item :label="$t('newbie.form.label23')" prop="validBet">
        <el-input
...
const rules = {
  ...
  validBet: [
    {
      required: true,
      message: i18n.global.t('newbie.form.message10'),
      trigger: 'blur'
    }
  ],
  betMultiple: [
  ...
  depositAmount: [
    {
      required: true,
      message: i18n.global.t('newbie.form.message9'),
      trigger: 'blur'
    }
  ]
}
