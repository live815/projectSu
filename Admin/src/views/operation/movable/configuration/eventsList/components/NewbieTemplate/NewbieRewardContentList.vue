    ...
    <el-form-item>
      <el-table :data="list" height="200">
        <el-table-column
          ...
          width="210"
        />
        <el-table-column prop="giftType" :label="$t('newbie.table.label19')" width="210">
        ...
        <el-table-column prop="giftAmount" :label="$t('newbie.table.label20')" width="210">
          <template #default="{ row }">
            <span v-if="row.giftAmount">{{ row.giftAmount }}</span>
            <span v-else>-</span>
          </template>
        </el-table-column>
        <el-table-column prop="betMultiple" :label="$t('newbie.table.label21')" width="210">
          <template #default="{ row }">
...
<script setup>
import { ref } from 'vue'
import addInsert from './addNewbieRewardInsert.vue'
