<template>
  <div class="app-container">
    ...
    <el-table :data="tableDataList" style="width: 100%">
      ...
      <el-table-column prop="memberVipLevel" :label="$t('operation.VIPlevel1')">
      ...
      <el-table-column prop="enterLocation" :label="$t('operation.accessentrance1')">
        <template #default="scope">
          ...
          <span v-if="scope.row.enterLocation == 4">{{ $t('operation.tip17') }} </span>
      ...
      <el-table-column prop="memberRegisterTime" :label="$t('operation.RegistratTime1')" sortable />
      <el-table-column prop="enterTime" :label="$t('operation.interviewtime')" sortable />
    </el-table>
    <pagination
      v-show="total > 0"
      :total="total"
...
import { accountTypes, vipGrades, equipmentTypes, accessEntrances } from '../../../models'
