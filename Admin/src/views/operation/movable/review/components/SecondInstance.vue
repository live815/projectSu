<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true">
      ...
      <el-form-item :label="$t('operation.applicant')" prop="createBy">
        <el-input
          v-model="queryParams.createBy"
          :placeholder="$t('operation.pleaseEnter')"
        />
      </el-form-item>
      <el-form-item :label="$t('operation.tip160')" prop="auditOneBy">
        <el-input
    ...
    <el-table :data="carouselList" style="width: 100%">
      ...
      <el-table-column width="180">
        <template v-slot:header>
          ...
          <div class="tab-title">{{ $t("operation.tip164") }}</div>
        </template>
        <template #default="scope">
          <div>
...
const queryParams = reactive({
  ...
  deliveryType: "", // 账号类型
  number: "", // 审核单号
  operateType: "1", // 0待一审 1一审通过（二审） 2结单查看
  tenantId: "",
  title: "", // 红利标题
  type: "", // 存入类型
  pageNum: 1,
