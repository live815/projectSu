    ...
    <el-row :gutter="20">
      <el-col :span="24" :xs="24">
        <el-form
          ...
          v-show="showSearch"
        >
          <el-form-item :label="$t('operation.tip12')" prop="userName">
            <el-input
              v-model="queryParams.title"
              :placeholder="$t('operation.tip13')"
              clearable
              style="width: 240px"
            />
          </el-form-item>
...
const columns = ref([
  ...
  { key: 1, label: i18n.global.t("operation.tips12"), visible: true },
...
const addCarousel = () => {
  (title.value = i18n.global.t("operation.add")), (rowItems.value = {});
  isShow.value = true;
};
