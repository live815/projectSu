    ...
    <el-row :gutter="20">
      <el-col :span="24" :xs="24">
        <el-form
          ...
          v-show="showSearch"
        >
          <el-form-item :label="$t('operation.floattitle')" prop="userName">
            <el-input
              v-model="queryParams.title"
              :placeholder="$t('operation.tip11')"
              clearable
              style="width: 240px"
            />
          </el-form-item>
...
const columns = ref([
  ...
  { key: 1, label: i18n.global.t("operation.floattitle1"), visible: true },
  ...
  {
    key: 13,
    label: i18n.global.t("operation.tip5"),
    visible: true,
  },
]);
// 表格列表
