    ...
    <el-row :gutter="20">
      <el-col :span="24" :xs="24">
        ...
        >
          ...
          <el-table-column
            :label="$t('operation.carouseltitle')"
            align="center"
            prop="title"
          ...
          />
          <el-table-column
            :label="$t('operation.Introduction')"
            align="center"
            prop="intro"
            v-if="columns[1].visible"
            :show-overflow-tooltip="true"
          ...
          >
            <template #default="scope">
              <div class="appImage">
                <div v-if="!scope.row.webSmallUrl" style="text-align: center">
                  {{ $t("operation.Nopictureyet") }}
                </div>
                <img
                  :src="getImgUrl(scope.row.webSmallUrl)"
                  style="width: 80px"
                  v-else
                />
              </div>
