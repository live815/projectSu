    ...
    <el-row :gutter="20">
      <el-col :span="24" :xs="24">
        <el-form
          ...
          v-show="showSearch"
        >
          <el-form-item :label="$t('operation.Popwindowtitle')" prop="userName">
            <el-input
        ...
        >
          ...
          <el-table-column
            :label="$t('operation.Popwindowtitle')"
            align="center"
            prop="title"
          ...
          <el-table-column
            :label="$t('operation.Popmode')"
            align="center"
            prop="popupType"
            width="160"
          >
            <template #default="scope">
              <div v-if="scope.row.popupType === 1">
                {{ $t("operation.tip9") }}
              </div>
              <div v-if="scope.row.popupType === 2">
                {{ $t("operation.tip10") }}
              </div>
            </template>
          </el-table-column>
...
const columns = ref([
  ...
  { key: 7, label: i18n.global.t("operation.Jumptype"), visible: true },
  { key: 8, label: i18n.global.t("operation.Jumpparameter"), visible: true },
