<template>
  <div class="manage-currency-address">
    <el-form :model="queryParams" ref="queryRef" :inline="true">
      <el-row :gutter="10">
        <el-col :span="5">
          <el-form-item :label="$t('member.EBPAYAddress')" prop="addr" class="full-width">
            <el-input
        ...
        <el-col :span="4">
          <el-form-item :label="$t('member.AddressStatus')" prop="status" class="full-width">
            <el-select
        ...
        <el-col :span="4">
          <el-form-item :label="$t('member.userNameNoQuote')" prop="userName" class="full-width">
            <el-input
        ...
        <el-col :span="7">
          <el-form-item :label="$t('member.addTimeNoQuote')" class="full-width">
            <el-date-picker
              v-model="dateRange"
        ...
        <el-col :span="8">
          <el-form-item :label="$t('member.totalWithdrawAmountNoQuote')" class="full-width">
            <el-col :span="11">
              <el-form-item label="" prop="totalWdMin" class="full-width">
                <el-input
            ...
            <el-col :span="11">
              <el-form-item label="" prop="totalWdMax" class="full-width">
                <el-input
        ...
        <el-col :span="4">
          <el-button @click="add" class="add-btn">{{ $t('member.add') }}</el-button>
    ...
    <el-table :data="bankManageList" :empty-text="$t('member.noData')">
      ...
      <el-table-column :label="$t('member.handle')" align="center" width="200">
        <template #default="scope">
          ...
          >
          <el-button size="small" type="success" v-else @click="startCard(scope.row)">{{
            $t('member.started')
          }}</el-button>
          <el-button size="small" type="warning" @click="delCard(scope.row)">{{
            $t('member.delete')
          }}</el-button>
          <el-button size="small" type="primary" @click="edit(scope.row)" v-if="false">{{
            $t('member.edit')
          }}</el-button>
        </template>
      </el-table-column>
...
import StartDisableEBDialog from './StartDisableEBDialog.vue'
import AddOrEditEBDia from './AddOrEditEBDia.vue'
import DeleteEBManageDia from './DeleteEBManageDia.vue'
import { getEBCryptocyList } from '@/api/member/bankcard/index'
