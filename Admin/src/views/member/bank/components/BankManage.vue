  ...
  <div class="bank-manage">
    <el-form :model="queryParams" ref="queryRef" :inline="true">
      <el-row :gutter="10">
        ...
        <el-col :span="5">
          <el-form-item :label="$t('member.accountAddr')" prop="accountAddr" class="full-width">
            <el-input
        ...
        <el-col :span="5" class="member-total">
    ...
    <el-table :data="bankManageList" :empty-text="$t('member.noData')">
      <el-table-column
        :label="$t('member.bankcardNoNoQuote')"
        align="center"
        prop="cardNo"
        width="180"
      ></el-table-column>
      <el-table-column
        :label="$t('member.banknameNoQuote')"
        align="center"
        width="160"
        prop="bankname"
      ></el-table-column>
      <el-table-column
        :label="$t('member.accountAddrNoQuote')"
        align="center"
        width="160"
        prop="accountAddr"
      >
      ...
      <el-table-column :label="$t('member.cardTypeNoQuote')" align="center" width="100" prop="cardType">
        <template #default="{ row }">
          <span>{{ filterLabel(cardTypeList,row.cardType) }}</span>
        </template>
      </el-table-column>
      <el-table-column
        :label="$t('member.bankcardStatus')"
        align="center"
        prop="status"
        width="110"
      >
...
import StartDisable from "./StartDisable.vue";
import AddOrEditCardDia from "./AddOrEditCardDia.vue";
import DeleteBankManageDia from "./DeleteBankManageDia.vue";
import { getBankcardList, delBankcard,updateBankcardStatus } from "@/api/member/bankcard/index";
