  ...
  <div class="app-container">
    <div class="app-body">
      <el-upload
        ...
        class="upload-demo"
        action="/admin/system/agent/promotion/domain/batchShortDomainSave"
        multiple
...
// import { saveDomainNamePoolInBatchesApi } from "@/api/funds/adjustment/index";
...
function handleExport() {
  ...
  a.href = "/static/agentDomainNamePool.xlsx";
  a.download = ` ${i18n.global.t(
    "agent.promoteShortDomainNameTemplate"
