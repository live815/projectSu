...
<template>
  <div class="app-container">
    ...
    <el-table :data="commissionTableDataList" style="width: 100%">
      ...
      <el-table-column property="applicantTime" :label="$t('agent.creatTime')" />
    </el-table>
    <pagination
      v-show="total > 0"
      :total="total"
    ...
    <el-dialog
      ...
      :title="$t('agent.detailsOfTheFirstTrialOfCommission')"
      width="1300px"
      :center="true"
...
const commissionReviewList = async () => {
  try {
    ...
    commissionTableDataList.value.forEach((item) => {
