  ...
  <div class="app-container">
    ...
    <el-form :model="queryParams" :inline="true" label-width="80px">
      ...
      <el-form-item>
        ...
        <el-button type="warning" icon="Download">{{ $t('agent.export') }}</el-button>
      </el-form-item>
    </el-form>
...
import { getWithdrawRecordApi, getThreeMchListApi } from '@/api/agent/agentRecord/agentRecord.js'
