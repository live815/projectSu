<template>
  <div class="recharge-store-pie">
    <div ref="pieRef" style="height: 400px" v-show="!isShow"></div>
...
const option = ref({
  ...
  title: {
    text: i18n.global.t("report.rechargeStorePercent"),
    left: "left",
  },
  tooltip: {
    trigger: "item",
  ...
  series: [
    {
      name: i18n.global.t("report.rechargeStorePercent"),
      type: "pie",
      radius: "50%", // 饼图半径
      data: [
