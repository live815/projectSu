<template>
  <div class="message-send-index">
    ...
    >
      ...
      >
        <template #default="{ row }">
          <span>{{ filterLabel(messageStatusList,row.sendStatus) }}</span>
        </template>
      </el-table-column>
