<template>
  <el-form size="small">
    ...
    <el-form-item>
      <el-radio v-model="radioValue" :label="2"> {{ $t('common.notSpecify') }} </el-radio>
    </el-form-item>
    ...
    <el-form-item>
      <el-radio v-model="radioValue" :label="3">
        ...
        <el-input-number v-model="cycle02" :min="cycle01 + 1" :max="31" /> {{ $t('common.days') }}
      </el-radio>
    </el-form-item>
    ...
    <el-form-item>
      <el-radio v-model="radioValue" :label="4">
        {{ $t('common.form') }}
        <el-input-number v-model="average01" :min="1" :max="30" /> {{ $t('common.daysStartEvery') }}
        <el-input-number v-model="average02" :min="1" :max="31 - average01" />
        {{ $t('common.daysImplement') }}
      </el-radio>
    </el-form-item>
    ...
    <el-form-item>
      <el-radio v-model="radioValue" :label="5">
        ...
        {{ $t('common.workDaysRecently') }}
      </el-radio>
    </el-form-item>

    <el-form-item>
      <el-radio v-model="radioValue" :label="6"> {{ $t('common.thisMonthLastDay') }} </el-radio>
    </el-form-item>
    ...
    <el-form-item>
      <el-radio v-model="radioValue" :label="7">
        ...
        <el-select
          ...
          :placeholder="$t('common.canMultipleSelect')"
          multiple
          :multiple-limit="10"
        >
          <el-option
