    ...
    <el-form size='small'>
        ...
        <el-form-item>
            <el-radio v-model='radioValue' :label="4">
                {{ $t('common.order') }}
                <el-input-number v-model='average01' :min="1" :max="4" /> {{ $t('common.week') }}
        ...
        <el-form-item>
            <el-radio v-model='radioValue' :label="6">
                {{ $t('common.specify') }}
                <el-select class="multiselect" clearable v-model="checkboxList" :placeholder="$t('common.canMultipleSelect')" multiple :multiple-limit="6">
                    <el-option v-for="item in weekList" :key="item.key" :label="item.value" :value="item.key" />
                </el-select>
            </el-radio>
        </el-form-item>
