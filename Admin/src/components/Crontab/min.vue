    ...
    <el-form size="small">
        ...
        <el-form-item>
            <el-radio v-model='radioValue' :label="2">
                ...
                <el-input-number v-model='cycle02' :min="cycle01 + 1" :max="59" /> {{ $t('common.minute') }}
            </el-radio>
        </el-form-item>
        ...
        <el-form-item>
            <el-radio v-model='radioValue' :label="3">
                {{ $t('common.form') }}
                <el-input-number v-model='average01' :min="0" :max="58" /> {{ $t('common.minuteStartEvery') }}
                <el-input-number v-model='average02' :min="1" :max="59 - average01" /> {{ $t('common.minuteImplement') }}
            </el-radio>
        </el-form-item>
        ...
        <el-form-item>
            <el-radio v-model='radioValue' :label="4">
                {{ $t('common.specify') }}
                <el-select clearable v-model="checkboxList" :placeholder="$t('common.canMultipleSelect')" multiple :multiple-limit="10">
