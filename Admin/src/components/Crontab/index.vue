<template>
    <div>
        <el-tabs type="border-card">
            <el-tab-pane :label="$t('common.second')" v-if="shouldHide('second')">
                <CrontabSecond
            ...
            <el-tab-pane :label="$t('common.minute')" v-if="shouldHide('min')">
                <CrontabMin
                    @update="updateCrontabValue"
                    :check="checkNumber"
                    :cron="crontabValueObj"
            ...
            <el-tab-pane :label="$t('common.commonHours')" v-if="shouldHide('hour')">
                <CrontabHour
                    @update="updateCrontabValue"
                    :check="checkNumber"
                    :cron="crontabValueObj"
            ...
            <el-tab-pane :label="$t('common.days')" v-if="shouldHide('day')">
                <CrontabDay
                    @update="updateCrontabValue"
                    :check="checkNumber"
                    :cron="crontabValueObj"
            ...
            <el-tab-pane :label="$t('common.month')" v-if="shouldHide('month')">
                <CrontabMonth
                    @update="updateCrontabValue"
                    :check="checkNumber"
                    :cron="crontabValueObj"
            ...
            <el-tab-pane :label="$t('common.week')" v-if="shouldHide('week')">
                <CrontabWeek
                    @update="updateCrontabValue"
                    :check="checkNumber"
                    :cron="crontabValueObj"
            ...
            <el-tab-pane :label="$t('common.year')" v-if="shouldHide('year')">
                <CrontabYear
                    @update="updateCrontabValue"
                    :check="checkNumber"
                    :cron="crontabValueObj"
        ...
        <div class="popup-main">
            <div class="popup-result">
                <p class="title">{{$t('common.timeExpress')}}</p>
                <table>
                    <thead>
                        <th v-for="item of tabTitles" :key="item">{{item}}</th>
                        <th>{{$t('common.cronExpress')}}</th>
                    </thead>
                    <tbody>
                        <td>
            ...
            <div class="pop_btn">
                <el-button type="primary" @click="submitFill">{{ $t('common.sure') }}</el-button>
                <el-button type="warning" @click="clearCron">{{ $t('common.reset') }}</el-button>
                <el-button @click="hidePopup">{{ $t('common.cancel') }}</el-button>
            </div>
        </div>
    </div>
</template>
...
const tabTitles = ref([i18n.global.t("common.second"), i18n.global.t("common.minute"), i18n.global.t("common.commonHours"), i18n.global.t("common.days"), i18n.global.t("common.month"), i18n.global.t("common.week"), i18n.global.t("common.year")])
