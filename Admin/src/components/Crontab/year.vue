    ...
    <el-form size="small">
        ...
        <el-form-item>
            <el-radio :label="4" v-model='radioValue'>
                {{ $t('common.form') }}
                <el-input-number v-model='average01' :min='fullYear' :max="maxFullYear - 1"/> {{ $t('common.yearStartPer') }}
                <el-input-number v-model='average02' :min="1" :max="10" /> {{ $t('common.yearImplement') }}
            </el-radio>
        ...
        <el-form-item>
            <el-radio :label="5" v-model='radioValue'>
                {{ $t('common.specify') }}
                <el-select clearable v-model="checkboxList" :placeholder="$t('common.canMultipleSelect')" multiple :multiple-limit="8">
