    ...
    <el-form size="small">
        ...
        <el-form-item>
            <el-radio v-model='radioValue' :label="2">
                ...
                <el-input-number v-model='cycle02' :min="cycle01 + 1" :max="23" />{{ $t('common.hours') }}
            </el-radio>
        </el-form-item>
        ...
        <el-form-item>
            <el-radio v-model='radioValue' :label="3">
                {{ $t('common.form') }}
                <el-input-number v-model='average01' :min="0" :max="22" /> {{ $t('common.hoursStartEvery') }}
                <el-input-number v-model='average02' :min="1" :max="23 - average01" /> {{ $t('common.hoursImplement') }}
            </el-radio>
        </el-form-item>
